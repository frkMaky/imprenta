...
class AuthController {
    ...
    public static function registro(Router $router) {
        ...
        $router->render('auth/registro', [
            'titulo' => 'Crea tu cuenta en FastPrintSpain',
            'usuario' => $usuario, 
            'alertas' => $alertas
        ]);
    }
            ...
            if(empty($alertas)) {
                ...
                if($usuario && $usuario->confirmado) {
                    ...
                    $router->render('auth/mensaje', [
                        'titulo' => 'Enviadas Instrucciones al Email',
                    ...
                    // Usuario::setAlerta('error', 'El Usuario no existe o no esta confirmado');
                    $router->render('auth/mensaje', [
                        'titulo' => 'No localizado el EMAIL',
                        'mensaje' => 'El Usuario no existe o no esta confirmado'
                    ]);
                }
            }
        }
    ...
    public static function mensaje(Router $router) {
        ...
        $router->render('auth/mensaje', [
            ...
            'mensaje' => 'Te hemos enviado un EMAIL para que la confirmes y actives tu cuenta'
        ]);
    }
