...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $mail->setFrom('cuentas@fastprintspain.com');
         ...
         $contenido = '<html>';
         $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en FastPrintSpain; pero es necesario confirmarla</p>";
